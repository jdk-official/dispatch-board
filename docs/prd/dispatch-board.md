...
- **AC-35** When a plan has been committed and only `generatedAt` then changes in `projectTabs/p.spec`, the refresh script shall report nothing to push. *(`Plan.test_generated_at_alone_is_not_a_change`.)*
