...
status: accepted  # confirmed by the owner at the plan gate, 2026-09-11 (spec row 8)
date: 2026-09-11
...
- **Sources.** Parent spec: `docs/backlog/specs/dispatch-board.md` (revision 3), Key decisions and row 8.
...
- **Technology.** Everything is Python standard library only (`sqlite3` in WAL mode, `http.server`), under `local/`.
